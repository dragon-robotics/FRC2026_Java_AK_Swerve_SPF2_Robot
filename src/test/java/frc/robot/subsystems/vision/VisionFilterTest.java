...
class VisionFilterTest {
  ...
  private static Stream<Arguments> rejectionCases() {
    return Stream.of(
        ...
        Arguments.of(
            "z below negative half a meter returns Z_OUT_OF_RANGE",
            observation(2, 4.0, 3.0, -0.500001, 0.0, 2.0, new int[] {1, 3}),
            0.0,
            0.0,
            false,
        ...
        Arguments.of(
            "field x above field length returns OUTSIDE_FIELD",
            observation(2, 16.001, 3.0, 0.0, 0.0, 2.0, new int[] {1, 3}),
            0.0,
            0.0,
            false,
            new Pose2d(),
            Optional.of("OUTSIDE_FIELD")),
        Arguments.of(
            "field y below zero returns OUTSIDE_FIELD",
            observation(2, 4.0, -0.001, 0.0, 0.0, 2.0, new int[] {1, 3}),
            0.0,
            0.0,
            false,
            new Pose2d(),
            Optional.of("OUTSIDE_FIELD")),
        Arguments.of(
            "field y above field width returns OUTSIDE_FIELD",
            observation(2, 4.0, 8.001, 0.0, 0.0, 2.0, new int[] {1, 3}),
            0.0,
            0.0,
            false,
            new Pose2d(),
        ...
        Arguments.of(
            "pitch below negative configured maximum returns TILT_UNSTABLE",
            observation(2, 4.0, 3.0, 0.0, 0.0, 2.0, new int[] {1, 3}),
            -8.000001,
            0.0,
            false,
            ...
            Optional.of("TILT_UNSTABLE")),
        Arguments.of(
            "roll below negative configured maximum returns TILT_UNSTABLE",
            observation(2, 4.0, 3.0, 0.0, 0.0, 2.0, new int[] {1, 3}),
            0.0,
            -8.000001,
            false,
